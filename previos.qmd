...
Estos dependen del sistema operativo en el que vayamos a trabajar. De entrada, pareciera ser más sencillo en plataformas como Windows, aunque esto puede cuestionarse un poco debido a la falta de controladores preinstalados en dicho sistema.
...
Probablemente en Linux surjan problemas de permisos. En Arch y derivadas se resuelve reiniciando después de ejecutar en consola:

```bash
sudo usermod -a -G uucp <usuario>
```

Donde `usuario` es el nombre de quien inicia la sesión en Linux.
